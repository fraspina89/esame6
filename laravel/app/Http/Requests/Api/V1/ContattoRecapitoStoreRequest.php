...
class ContattoRecapitoStoreRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'idTipoRecapito' => 'required|integer|exists:tipiRecapito,idTipoRecapito',
            'valore' => 'required|string|max:255|min:3',
    ...
    {
        return [
            'idTipoRecapito.required' => 'Il tipo di recapito è obbligatorio.',
            ...
            'valore.required' => 'Il valore del recapito è obbligatorio.',
